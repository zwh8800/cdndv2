...
| 改进 | 工作量 | 影响 | 状态 |
|------|--------|------|------|
| 复合工具实现（战斗系统优先） | 高 | 战斗工具从 12 降至 5 | ✅ 已完成 |
| 复合工具实现（角色/场景/查询） | 高 | 总工具数从 ~97 降至 ~46 | ✅ 已完成 |
| SubAgent ToolsForTask() 过滤 | 中 | SubAgent 工具数降至 5-8 | ✅ 已完成 |
| 战斗 Plan-Then-Act 模式 | 中 | 战斗 LLM 调用减少 50-80% | ✅ 已完成 |
